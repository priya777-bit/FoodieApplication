...
//
//        private static final Logger logger = LoggerFactory.getLogger(SearchLoggingAspect.class);
//
//        @Pointcut("execution(* com.example.searchService.controller.SearchController.* (..) )")
...
//        }
//
//        @Pointcut("execution(* com.example.searchService.repository.SearchRepository.* (..) )")
...
//        }
//
//        @Pointcut("execution(* com.example.searchService.service.SearchService.* (..) )")
